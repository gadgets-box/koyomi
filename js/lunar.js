...
(function (global) {
  ...
  const SEKKI_NAMES = [
    { deg: 0, ja: "春分", en: "Spring Equinox",
      desc: "昼と夜の長さがほぼ等しくなる日", descEn: "Day and night are nearly equal in length" },
    { deg: 15, ja: "清明", en: "Pure Brightness",
      desc: "万物が清らかで生き生きと見える頃", descEn: "All things appear fresh and vivid" },
    { deg: 30, ja: "穀雨", en: "Grain Rain",
      desc: "穀物を潤す春の雨が降る頃", descEn: "Spring rains that nourish the grain crops" },
    { deg: 45, ja: "立夏", en: "Start of Summer",
      desc: "夏の気配が感じられ始める頃", descEn: "The first signs of summer appear" },
    { deg: 60, ja: "小満", en: "Lesser Fullness",
      desc: "草木が茂り、命が満ち始める頃", descEn: "Plants grow lush as life fills the land" },
    { deg: 75, ja: "芒種", en: "Grain in Ear",
      desc: "稲や麦の穂が実り始める頃", descEn: "Grain crops begin to form ears" },
    { deg: 90, ja: "夏至", en: "Summer Solstice",
      desc: "一年で昼が最も長くなる日", descEn: "The longest day of the year" },
    { deg: 105, ja: "小暑", en: "Lesser Heat",
      desc: "本格的な暑さが始まる頃", descEn: "The heat of summer begins in earnest" },
    { deg: 120, ja: "大暑", en: "Greater Heat",
      desc: "一年で最も暑さが厳しくなる頃", descEn: "The hottest stretch of the year" },
    { deg: 135, ja: "立秋", en: "Start of Autumn",
      desc: "秋の気配が感じられ始める頃", descEn: "The first signs of autumn appear" },
    { deg: 150, ja: "処暑", en: "End of Heat",
      desc: "暑さが和らぎ始める頃", descEn: "The summer heat begins to ease" },
    { deg: 165, ja: "白露", en: "White Dew",
      desc: "朝夕の草花に露が結び始める頃", descEn: "Dew begins to form on plants at dawn" },
    { deg: 180, ja: "秋分", en: "Autumn Equinox",
      desc: "昼と夜の長さがほぼ等しくなる日", descEn: "Day and night are nearly equal in length" },
    { deg: 195, ja: "寒露", en: "Cold Dew",
      desc: "露が冷たく感じられ始める頃", descEn: "The morning dew begins to feel cold" },
    { deg: 210, ja: "霜降", en: "Frost's Descent",
      desc: "霜が降り始める頃", descEn: "Frost begins to form" },
    { deg: 225, ja: "立冬", en: "Start of Winter",
      desc: "冬の気配が感じられ始める頃", descEn: "The first signs of winter appear" },
    { deg: 240, ja: "小雪", en: "Lesser Snow",
      desc: "わずかに雪が降り始める頃", descEn: "Light snow begins to fall" },
    { deg: 255, ja: "大雪", en: "Greater Snow",
      desc: "雪が本格的に降り積もる頃", descEn: "Snow begins to fall heavily and settle" },
    { deg: 270, ja: "冬至", en: "Winter Solstice",
      desc: "一年で夜が最も長くなる日", descEn: "The longest night of the year" },
    { deg: 285, ja: "小寒", en: "Lesser Cold",
      desc: "寒さが本格化し始める頃", descEn: "The cold begins to set in seriously" },
    { deg: 300, ja: "大寒", en: "Greater Cold",
      desc: "一年で最も寒さが厳しくなる頃", descEn: "The coldest stretch of the year" },
    { deg: 315, ja: "立春", en: "Start of Spring",
      desc: "春の気配が感じられ始める頃", descEn: "The first signs of spring appear" },
    { deg: 330, ja: "雨水", en: "Rain Water",
      desc: "雪が雨に変わり、氷が解け始める頃", descEn: "Snow turns to rain and ice begins to melt" },
    { deg: 345, ja: "啓蟄", en: "Awakening of Insects",
      desc: "冬眠していた虫たちが動き出す頃", descEn: "Hibernating insects awaken and stir" },
  ];
